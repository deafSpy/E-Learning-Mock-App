...
const StudentHeader: React.FC = () => {
  ...
  return (
    <div className='font-sans relative border-b border-b-gray-300 z-[3] w-full'>
      <Disclosure
        as='nav'
        className=' pl-8 pr-8 p-2 md:p-2 lg:p-3 lg:flex lg:justify-center'
      >
        {({ open }) => (
          <>
              ...
              <div className='flex items-center justify-between md:h-14 lg:h-16'>
                      ...
                      {navigation.map((item) => (
                        <Link
                          ...
                          className={classNames(
                            item.current
                              ? "bg-[#FF829F] text-white font-semibold"
                ...
                {isLoggedIn&&user==='student'? (
                  <div className='hidden md:ml-5 md:flex items-center justify-between'>
                    <div className=''>
                      <Link to='/dashboard'>
                        <Button size='md' color='blue-gray' className="bg-[#FF829F]">
                          Dashboard
                        </Button>
                      </Link>
                    </div>
                  ...
                  <div className='overflow-hidden'>
                    <div className='hidden h-8 w-64 lg:mt-3 lg:h-12 lg:w-72 md:flex'>
                      <div className='space-x-4 '>
                        <Link to='/login'>
                          <button className='bg-blue-gray-300 hover:bg-[#FF829F] text-xs lg:text-sm text-white font-bold py-2 px-2 rounded focus:outline-none focus:shadow-outline'>
                            Login
                          </button>
                        </Link>
                        <Link to='/register'>
            ...
            <Disclosure.Panel className='lg:hidden'>
              ...
              <div className='border-t border-gray-700 pb-3 pt-4'>
                <div className='mt-3 space-y-1 px-2'>
                  <Link to='/login'>
                    <button className='w-full mb-2 block rounded-md px-3 py-2 text-base font-medium  text-gray-200 bg-blue-gray-300 hover:bg-[#FF829F]   hover:text-white'>
                      Login
                    </button>
                  </Link>
                  <Link to='/register'>
